...
0.97$ between $f^+_{cp}$ and $H_p$ --- is recovered at $r = 0.864$
across all 23{,}391 fragments.
The residual gap of $0.106$ is systematically traced to the
...
The same mechanism increases the number of fragmentation candidates
identified by the three-way filter ($n \geq 200$, $H_p \geq 0.25$,
PLM $\geq 3$ at $t_p = 0.025$): 183 proteins vs.\ the paper's
$\approx 86$.
...
reveals a 5.92-fold enrichment of fragmented proteins in the arity bin
$(a_{25}=7, a_{75}=15)$ (Fisher exact test, $p = 1.61 \times 10^{-3}$).
